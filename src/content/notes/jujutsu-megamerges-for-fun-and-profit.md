...
<!--
Asciinema plan: Commit + rebase + bookmark
- Prep: feature commit + megamerge commit.
- Edit feature file.
- `jj commit -m 'feature: Add widget'`
- `jj rebase -r @ -A <feature-id> -B <megamerge-id>`
- `jj bookmark move -f <feature-bookmark> -t @`
- `jj log`
-->
...
<!--
Asciinema plan: stack alias
- Prep: megamerge exists, plus a separate feature stack.
- `jj log`
- `jj stack <revset>` (shortest unique change ID for stack tip)
- `jj log`
-->
...
<!--
Asciinema plan: stage alias
- Prep: megamerge + stack to include.
- `jj log`
- `jj stage`
- `jj log`
-->
...
<!--
Asciinema plan: rebase onto trunk (normal)
- Prep: commits on top of trunk.
- `jj log`
- `jj rebase -d <trunk-id>`
- `jj log`
-->
...
<!--
Asciinema plan: rebase onto trunk (fails)
- Prep: include an immutable/protected commit.
- `jj rebase -d <trunk-id>` (expect failure)
-->
...
<!--
Asciinema plan: restack alias
- Prep: mixed mutable/immutable commits on top of trunk.
- `jj restack`
- `jj log`
-->
...
<!--
Asciinema plan: full megamerge workflow
- `jj log`
- Edit a file that belongs in an existing commit.
- `jj absorb`
